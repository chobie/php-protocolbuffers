...
if test $PHP_PROTOCOLBUFFERS != "no"; then
    ...
    PHP_PROTOBUF_SRCS="protocolbuffers.c descriptor.c descriptor_builder.c field_descriptor.c message.c message_options.c php_message_options.c unknown_field.c unknown_field_set.c helper.c extension_registry.c core.c serializer.c"
